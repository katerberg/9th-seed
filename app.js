...
function unpermissioned(channelName, message, user) {
  if (message === '!twitter') {
    ...
    message === '!decklists' ||
    message === '!draft') {
    return client.say(channelName, 'Spreadsheet with draft picks is at https://docs.google.com/spreadsheets/d/1MKkuuQ1hYIE4_uOXEUBUcTMSu1yfsgwYgHjIGyNQtm4/edit?usp=sharing');
